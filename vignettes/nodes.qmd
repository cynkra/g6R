...
These function can only be used in a Shiny app context. They allow you to get or update the nodes data in the graph after it has been created. The functions are:
