...
# validate plugins works
    ...
    Condition
      ...
      ! 'blabla' is not a valid plugin. Valid choices are: background, bubble-sets, contextmenu, edge-bundling, edge-filter-lens, fisheye, fullscreen, grid-line, history, hull, legend, minimap, search, snapline, timebar, toolbar, tooltip, watermark.
    Code
      g6_plugins(g6(), list(test = 1))
    Condition
      Error in `validate_component()`:
      ! 'unknown' is not a valid plugin. Valid choices are: background, bubble-sets, contextmenu, edge-bundling, edge-filter-lens, fisheye, fullscreen, grid-line, history, hull, legend, minimap, search, snapline, timebar, toolbar, tooltip, watermark.
