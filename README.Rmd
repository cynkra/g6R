...
`{shinyG6}` provides R bindings to the G6 graph [library](https://g6.antv.antgroup.com/en).

## Installation

You can install the development version of shinyG6 from [GitHub](https://github.com/) with:
